...
# Current data structure: RPM,SteerX,SteerY,LeftClick,RightClick,Zoom
...
def simulate_zoom(zoom_change):
    """Translates Rotary Dial into Mouse Scroll for scrolling or zooming."""
    if zoom_change != 0:
...
def main():
    ...
    while True:
        try:
            ...
            if line:
                # Parse the data packet: RPM,SteerX,SteerY,LeftClick,RightClick,Zoom
                parts = line.split(',')
