...
// in the EXACT 1-part format required by the Python script: 
// RPM\n
...
void loop() {
  ...
  if (radio.available()) {
    ...
    // Print the received data to the Serial port in the EXACT 1-part format: R\n
    Serial.println(receivedData.rpm);
  }
